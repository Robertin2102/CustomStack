...
public class ArrayStack<T> implements Stack<T> {
    ...
    public void addCapacity(){
        if (top==data.length) {//Si el arreglo esta lleno, vamos a aunmentar la capacidad
    ...
    public void println() {
        if (isEmpty()) {
            System.out.println("Stack vacío si nadita que mostrar");
            return;
        }
        
        System.out.print("Stackkkk: ");
        for (int i = 0; i < top; i++) {
